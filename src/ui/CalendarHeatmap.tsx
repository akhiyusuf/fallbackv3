  ...
  return (
    <View>
      {/*
        ...
        instead via this visually-hidden sibling `Text` (the kit's one canonical sr-only
        idiom, `@/ui/a11y` — pass 3, carried item 2: same spelling as `TrendGraph`) that
        sits OUTSIDE the interactive subtree rather than wrapping it, so it adds context
