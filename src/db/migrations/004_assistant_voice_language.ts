/**
 * M1 (landed by the architect). Migration 4 — architect CR-2, raised in wave-2 code review.
 *
...
export const MIGRATION_004_ASSISTANT_VOICE_LANGUAGE: Migration = {
  version: 4,
  name: 'settings.assistant_language + settings.assistant_voice (architect CR-2)',
  up: `
